...
class PushUriRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['uri_details'] = $data['uri_details'] ?? null;
        $this->container['ns2'] = $data['ns2'] ?? null;
        $this->container['ver'] = $data['ver'] ?? null;
        $this->container['ts'] = $data['ts'] ?? null;
        $this->container['txn'] = $data['txn'] ?? null;
        $this->container['org_id'] = $data['org_id'] ?? null;
        $this->container['keyhash'] = $data['keyhash'] ?? null;
    }
    ...
    {
        return $this->container['keyhash'];
    }

    /**
     * Sets keyhash
     *
     * @param string|null $keyhash keyhash
     *
     * @return self
     */
    public function setKeyhash($keyhash)
    {
        $this->container['keyhash'] = $keyhash;
