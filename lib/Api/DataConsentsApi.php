...
class DataConsentsApi
{
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\DataConsentFinancialsDto' === '\SplFileObject') {
                        ...
                        if ('\MyDataMyConsent\Model\DataConsentFinancialsDto' !== 'string') {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\DataConsentDocument' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\DataConsentDocument' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\OrganizationFinancialAccountDto' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\OrganizationFinancialAccountDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\UserAccountFinancialTransactionsDtoPaginatedList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\UserAccountFinancialTransactionsDtoPaginatedList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
    ...
    public function getConsentedFinancialAccountTransactionsRequest($consent_id, $account_id, $filters = null, $from_date_time_utc = null, $to_date_time_utc = null, $page_no = 10, $page_size = 25)
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $from_date_time_utc,
            'fromDateTimeUtc', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\DataConsentDetailsPaginatedList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\DataConsentDetailsPaginatedList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\DataConsent' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\DataConsent' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
            ...
            switch($statusCode) {
                case 200:
                    if ('\MyDataMyConsent\Model\OrganizationFinancialTransactionsDtoPaginatedList' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\MyDataMyConsent\Model\OrganizationFinancialTransactionsDtoPaginatedList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }
