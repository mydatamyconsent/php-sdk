...
/**
 * ConsentedDocument Class Doc Comment
 *
 * @category Class
 ...
 */
class ConsentedDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsentedDocument';
    ...
    protected static $openAPITypes = [
        ...
        'issuer' => '\MyDataMyConsent\Model\ConsentDocumentIssuer',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('digital_signatures', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets issuer
     *
     * @return \MyDataMyConsent\Model\ConsentDocumentIssuer
     */
     ...
     * Sets issuer
     *
     * @param \MyDataMyConsent\Model\ConsentDocumentIssuer $issuer issuer
     *
     * @return self
     */
    ...
    public function setDigitalSignatures($digital_signatures)
    {
        ...
        if (is_null($digital_signatures)) {
            throw new \InvalidArgumentException('non-nullable digital_signatures cannot be null');
        }
