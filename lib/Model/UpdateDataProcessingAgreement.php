...
/**
 * UpdateDataProcessingAgreement Class Doc Comment
 *
 * @category Class
 * @description Update data processing agreement details.
 * @package  MyDataMyConsent
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class UpdateDataProcessingAgreement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateDataProcessingAgreement';
     ...
     * Sets body
     *
     * @param string $body Agreement body content.
     *
     * @return self
     */
     ...
     * Sets attachment_url
     *
     * @param string $attachment_url Agreement attachment file URL.
     *
     * @return self
     */
