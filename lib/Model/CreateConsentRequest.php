...
class CreateConsentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('consent_template_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['consent_template_id'] === null) {
            $invalidProperties[] = "'consent_template_id' can't be null";
        }
     ...
     *
     * @param string $consent_template_id Consent request template id
     *
     * @return self
     */
    public function setConsentTemplateId($consent_template_id)
    {
        ...
        if (is_null($consent_template_id)) {
            throw new \InvalidArgumentException('non-nullable consent_template_id cannot be null');
        }
